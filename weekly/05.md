...
**Slide #15 - `.slice()` to mak a copy of an array**
...
```js
// Number is a value (or primitive) type and is immutable
let num1 = 5;
...
console.log("colors1=",colors1); // is still 5 
console.log("colors2=",colors2); // 5
```
