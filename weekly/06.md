...
console.log(car1.make,car1.model + "'s", "coolness factor is", car1["coolness factor"]); // Ford Bronco's coolness factor is 
10

console.log(car2.make,car2.model + "'s", "coolness factor is", car2["coolness factor"]); // Jeep Gladiator's coolness factor is 
11
```
